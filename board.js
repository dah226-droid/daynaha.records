const boardLogoImage = document.querySelector('.top-nav .dot-logo img');
...
if (boardLogoImage) {
  ...
  function updateLogoSpinFromScroll() {
    ...
    boardLogoImage.style.transform = `rotate(${spinDegrees}deg)`;
  }
...
(function setupOtherRecordsRandomizer() {
  ...
  // Side A carousel options (exclude Board: carousel-vinyl-06).
  const candidates = [
