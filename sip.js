const umamiLogoImage = document.querySelector('.top-nav .dot-logo img');
...
if (umamiLogoImage) {
  ...
  function updateLogoSpinFromScroll() {
    ...
    umamiLogoImage.style.transform = `rotate(${spinDegrees}deg)`;
  }
...
function getOtherRecordsStopScrollY() {
  ...
  const deltaToStop = rect.bottom - ((window.innerHeight || 0) + 33);
